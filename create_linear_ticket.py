...
#     """
#     Extracts a concise title from an enriched bug report.
#     Assumes the report contains a line like: **Title:** <title text>
    
#     Parameters:
#       - enriched_report (str): The structured bug report.
    
#     Returns:
#       - str: The extracted title, or a default title if not found.
#     """
...
#     # Extract a concise title from the enriched report.
...
#     # Send the request to the Linear GraphQL endpoint.
#     response = requests.post(url, headers=headers, json={"query": mutation, "variables": variables})
#     result = response.json()
...
# if __name__ == "__main__":
#     # Example enriched report (simulate the output from your GPT enrichment).
#     sample_report = """
#     **Title:** Homepage Carousel Not Cycling Through Images
